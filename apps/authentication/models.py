...
class Users(db.Model, UserMixin):
    ...
    #__PROFILE_FIELDS__
    user descrition = db.Column(db.Text, nullable=True)
    is active = db.Column(db.Boolean, nullable=True)
    last login = db.Column(db.DateTime, default=db.func.current_timestamp())
